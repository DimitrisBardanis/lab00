...
```{r setup-tibble}
team_data <- tibble(
  name = c("Dimitris Bardanis", "Dimitris Agouridids", 
           "Sam Prior", "Shane Chesen"),
  github_username = c("S-Pri0r", "shanechesen", "DimitrisBardanis", 
                      "dimitrisagouridis"), 
  colour = c("darkorange", "lightgreen", "darkgreen", 
             "blue"),
  hobby = c("guitar", "travelling", 
            "tennnis", "football"),
